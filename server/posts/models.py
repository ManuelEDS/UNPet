...
class Publicacion(models.Model):
    ...
    fechapublicacion = models.DateTimeField(max_length=45)  # Field name made lowercase.
    ...
    idpersona = models.ForeignKey('accounts.Persona', models.DO_NOTHING, related_name='Publicaciones_integrante_organizacion', blank=True, null=True)  # Field name made lowercase.
...
class Comentario(models.Model):
    ...
    respondedor = models.ForeignKey('accounts.Persona', on_delete=models.CASCADE, related_name='comentarios_respuesta', blank=True, null=True)
