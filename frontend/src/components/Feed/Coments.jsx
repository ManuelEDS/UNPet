...
export const Coment = ({ coment, post, parent = {} }) => {
    ...
    const isAnswer = Object.keys(parent).length
        ...
        <>
            <div className="m-5 p-4">
                ...
                <div className="text-gray-800 text-sm mb-4">
                    ...
                    {isAnswer ? <><div>
                        <a href={"/user/" + username}><p className="text-sm font-bold">@{parent.autor}</p></a>
                ...
                <div className="flex items-center justify-between m-0">
                    <div className="flex ">
                        ...
                        {!isAnswer && <a href="/login" className="flex items-center ml-6">
