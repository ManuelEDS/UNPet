...
urlpatterns = [
    ...
    path('api/password-reset/', djangoViews.PasswordResetView.as_view(), name='password_reset'),
    path('api/password-reset/done/', djangoViews.PasswordResetDoneView.as_view(), name='password_reset_done'),
    path('api/reset/<uidb64>/<token>/', djangoViews.PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
    path('api/reset/done/', djangoViews.PasswordResetCompleteView.as_view(), name='password_reset_complete'),
